...
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.addToPurchaseList(paymentEvent)];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.deleteFromPurchaseList(paymentEvent.data)];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.userRegister(userData)];
                    case 1:
                        response = _a.sent();
                        if (response.success) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = call.request;
                        return [4 /*yield*/, userService.VerifyOtp(data)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = call.request;
                        return [4 /*yield*/, userService.ResendOTP(data)];
                    case 1:
                        response = _a.sent();
                        callback(null, response);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log('trig');
                        data = call.request;
                        return [4 /*yield*/, userService.userLogin(data)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.blockUnblock(userId)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        error_4 = _a.sent();
                        callback(error_4); // Pass error to callback
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.getUserById(data)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        error_5 = _a.sent();
                        callback(error_5); // Pass error to callback
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.fetchStudents()];
                    case 1:
                        response = _a.sent();
                        console.log(response, 'response from controller');
                        callback(null, response);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.updateUserDetails(data)];
                    case 1:
                        response = _a.sent();
                        console.log(response, "response from controller.");
                        callback(null, response);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = call.request;
                        return [4 /*yield*/, userService.addToCart(data)];
                    case 1:
                        response = _a.sent();
                        console.log(response, 'response from controller');
                        callback(null, response);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = call.request;
                        return [4 /*yield*/, userService.isInCart(data)];
                    case 1:
                        response = _a.sent();
                        callback(null, response);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = call.request;
                        return [4 /*yield*/, userService.checkCourseStatus(data)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.getCartItems(data)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        console.log(data);
                        return [4 /*yield*/, userService.checkIsBlocked(data)];
                    case 1:
                        response = _a.sent();
                        console.log(response, 'response from controller');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.resetPassword(data)];
                    case 1:
                        response = _a.sent();
                        callback(null, response);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.sendEmailOtp(data)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.resendEmailOtp(data)];
                    case 1:
                        response = _a.sent();
                        console.log('reseponse from controller', response);
                        callback(null, response);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.resetPasswordVerifyOTP(data)];
                    case 1:
                        response = _a.sent();
                        console.log(response, 'response from controller');
                        callback(null, response);
    ...
    UserController.prototype.linkNameToReview = function (call, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, response, reviewData, error_14;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("vann");
                    ...
                    case 1:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.attachReviewById(data)];
                    case 2:
                        response = _a.sent();
    ...
    UserController.prototype.linkNameToMessages = function (call, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, response, messageData, error_15;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("vann");
                    ...
                    case 1:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.attachMessageById(data)];
                    case 2:
                        response = _a.sent();
                        console.log(response, 'this is the response');
                        messageData = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = call.request;
                        return [4 /*yield*/, userService.fetchUsersByIds(data)];
                    case 1:
                        response = _a.sent();
                        console.log(response);

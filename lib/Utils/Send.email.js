...
var SendVerificationMail = function (email, otp) { return __awaiter(void 0, void 0, void 0, function () {
    var transporter, mailOptions, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                console.log(ENV_configs_1.configs.DWL_EMAIL, 'Sender');
            ...
            case 2:
                error_1 = _a.sent();
                throw new Error("Failed to send verification email: ".concat(error_1));
